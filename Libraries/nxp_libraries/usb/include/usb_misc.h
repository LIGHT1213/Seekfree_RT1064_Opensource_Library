...
#define USB_RAM_ADDRESS_ALIGNMENT(n) __attribute__((aligned(n)))
#define USB_LINK_DMA_INIT_DATA(sec) __attribute__((section(#sec)))
#define USB_LINK_USB_GLOBAL __attribute__((section("m_usb_global"))) 
#define USB_LINK_USB_BDT __attribute__((section("m_usb_bdt"))) 
#define USB_LINK_USB_GLOBAL_BSS __attribute__((section(".bss.m_usb_global"))) 
#define USB_LINK_USB_BDT_BSS __attribute__((section(".bss.m_usb_bdt"))) 
#define USB_LINK_DMA_NONINIT_DATA __attribute__((section("m_usb_dma_noninit_data"))) 
#define USB_LINK_NONCACHE_NONINIT_DATA __attribute__((section("NonCacheable"))) 
#elif defined(__GNUC__)
